...
CASE = {'case_id': '14_hole_simple_001_d6_depth10',
 ...
 'params': {'d_mm': 6, 'depth_mm': 10},
 'priority': 'P1',
 'title': 'Standard holes (simple, counterbore, countersink, tapped, cosmetic thread): 001_d6_depth10'}
...
if "SCDM_BATCH" not in globals():
    ...
    run_standalone(CASE, build, r"D:\training\caedecoder\scdm_cases\14_holes_threads\14_hole_simple_001_d6_depth10.py")
