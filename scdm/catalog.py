...
TABS: Tuple[Tab, ...] = (
    ...
    C("create.hole_tapped", "攻丝孔", "Tapped", "M4", "cyl"),
    C("create.dimple", "凹坑", "Dimple", "M4", "cyl"),
    C("create.louver", "百叶", "Louver", "M4", "cyl"),
    C("create.knockout", "敲落", "Knockout", "M4", "cyl"),
    C("create.gusset", "角撑", "Gusset", "M4", "bend"),
    C("create.tab", "舌片", "Tab", "M4", "note"),
    ...
    Tab("assembly", "组件", "Assembly", (
        Group("组件", "Component", (
          ...
          note="沿轴/径向/等比三种模式，位移可数且可还原（R88）"),
    ...
    Tab("workbench", "Workbench", "Workbench", (
        ...
        Group("仿真准备", "Sim Prep", (
            ...
            C("mesh.volume", "体网格", "Volume Mesh", "M5", "box",
              note="体素四面体填充 + 体积闭式对拍"),
    ...
    Tab("surface", "曲面", "Surface", (
        Group("曲面", "Surface", (
            ...
            C("surface.untrim", "去修剪", "Untrim", "M5", "untrim"),
            C("surface.extend", "延伸", "Extend", "M5", "extend"),
            C("surface.patch", "补面", "Patch", "M5", "patch"),
            C("surface.blend", "过渡", "Blend", "M5", "blend"),
        )),
    )),
    Tab("sheet", "钣金", "Sheet Metal", (
        Group("钣金", "Sheet Metal", (
            ...
            C("sheet.cross_break", "十字压筋", "Cross Break", "M5", "jog",
              note="浅 V 形/圆弧压槽（截面积×长度闭式）"),
...
M5_LIVE = {
    ...
    "sheet.conical", "sheet.axial", "sheet.cross_break",
    ...
    "mesh.surface", "mesh.volume", "mesh.report",
